%global nautilus_version 42
%global git_rev f664378dd70370a9048805ca9d9a45b086a4fc08
%global git_short f664378d

%global tarball_version %%(echo %{version} | tr '~' '.')

Name:           nautilus42-python
Version:        3.99
Release:        0.1git%{git_short}%{?dist}
Summary:        Python bindings for Nautilus

License:        GPLv2+
URL:            https://wiki.gnome.org/Projects/NautilusPython
#Source0:        https://download.gnome.org/sources/nautilus-python/4.0/nautilus-python-%{tarball_version}.tar.xz
Source0:	https://gitlab.gnome.org/GNOME/nautilus-python/-/archive/%{git_rev}/nautilus-python-%{git_rev}.tar.bz2
#Source0:        nautilus-python-%{git_short}.tar.xz

BuildRequires:  gtk-doc
BuildRequires:  meson
BuildRequires:  nautilus42-devel >= %{nautilus_version}
BuildRequires:  pygobject3-devel
BuildRequires:  python3-devel

Requires:       nautilus42-extensions%{?_isa} >= %{nautilus_version}
Requires:       python3-gobject-base%{?_isa}

Provides:       nautilus-python = %{version}-%{release}
Provides:       nautilus-python%{?_isa} = %{version}-%{release}
Conflicts:      nautilus-python <= 5.0
...
%prep
%autosetup -p1 -n nautilus-python-%{git_rev}
...
%changelog
* Tue Nov 15 2022 FeRD (Frank Dana) <ferdnyc@gmail.com> - 4.0-1
- Build nautilus42-compatible extension
...
* Tue May 26 2020 Miro HronÄ�ok <mhroncok@redhat.com> - 1.2.3-5
- Rebuilt for Python 3.9

* Wed Jan 29 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_32_Mass_Rebuild

* Mon Aug 19 2019 Miro HronÄ�ok <mhroncok@redhat.com> - 1.2.3-3
