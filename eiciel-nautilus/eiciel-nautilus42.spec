...
BuildRequires: nautilus42-extensions
...
Provides: eiciel%{?_isa} = %{version}-%{release}
Provides: eiciel = %{version}-%{release}
Conflicts: eiciel <= 0.11
...
%{ext_dir}/libeiciel*.so
%{_datadir}/metainfo/*.appdata.xml
%{_datadir}/icons/hicolor/*/apps/*eiciel.*


%changelog
* Thu Nov 17 2022 FeRD (Frank Dana) <ferdnyc@gmail.com> - 0.9.13.1-1
- Revert to gtk3 version for nautilus42 compatiblity
